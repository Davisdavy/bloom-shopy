...
import 'package:bloom/ui/tabs/more_tab.dart';
import 'package:bloom/ui/tabs/shop_tab.dart';
import 'package:bloom/ui/tabs/stores_tab.dart';
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items:  [
          ...
          BottomNavigationBarItem(
            icon:Image.asset("assets/images/more.png", height: 30,),
            activeIcon: Image.asset("assets/images/more_active.png", height: 30,),
            label: '',
